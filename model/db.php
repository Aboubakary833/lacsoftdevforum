...
class DataBase {
    ...
    public function getData(string $toSelect, string $table, $condition = null, $limit = null) {
    ...
    public function setData(array $toInsert, string $table, string $columns, string $condition = null) {
        if(isset($condition)) {
